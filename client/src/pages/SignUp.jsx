      ...
      <div className="mx-auto flex p-3 max-w-3xl flex-col md:flex-row md:items-center gap-5">
        ...
        <div className="flex-1">
          ...
          <form className="flex flex-col gap-4" onSubmit={handlerSubmit}>
              <div>
                  <Label className="" htmlFor="username">Your username</Label>
                  <TextInput type="text" placeholder="Username" id="username" onChange={handlerChange} />
              </div>
              <div>
              ...
              <div>
                  ...
                  <TextInput type="password" placeholder="Password" id="password" onChange={handlerChange} />
              </div>
          ...
          <div className="flex gap-2 text-sm mt-5">
            <span>Tu as un compte ? connecte-toi </span>
